...
export default function Hero5() {
  ...
  return (
    <div>
      <section className="overflow-hidden pt-10 px-6 pb-12 lg:pt-32  lg:pb-[90px] lg:px-20  dark:bg-dark ">
          ...
          <div className="flex flex-wrap   items-center justify-between -mx-4">
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                />
                <p className="  mb-2 mt-6 text-base text-gray-300 dark:text-dark-6">
                ...
                <Link
                  to={"/products"}
                  className="relative inline-block text-lg mt-6 group"
                >
                  ...
                  <span
                    className="absolute bottom-0 right-0 w-full h-12 -mb-1 -mr-1 transition-all duration-200 ease-linear bg-gray-400 rounded-lg group-hover:mb-0 group-hover:mr-0"
