...
import img11 from "../../Data/images/Palmistry.png";
...
export default function Hero3() {
  ...
  return (
    <div className="px-6 lg:px-0">
      ...
      <section className="overflow-hidden pt-10 pb-12 lg:pt-[40px]  lg:pb-[90px] lg:px-20  dark:bg-dark">
        <div className="container mx-auto">
          <div className="flex flex-row-reverse flex-wrap-reverse items-center justify-between -mx-4">
            ...
            <div className="w-full px-4  lg:w-[60%]">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-0 text-lg font-semibold text-gray-200 text-primary">
                  Why Choose Us
                </span>
                <h2 className=" w-full bg-gradient-to-b from-white to-gray-400 bg-clip-text font-bold text-transparent text-3xl sm:text-4xl mb-4 py-2">
                  Make your customers happy by giving services.
                </h2>
                <p className="hidden lg:block mb-2 mt-6 text-base text-gray-300 dark:text-dark-6">
                  It is a long established fact that a reader will be distracted
                  by the readable content of a page when looking at its layout.
                  The point of using Lorem Ipsum is that it has a more-or-less.
                </p>
                <p className="hidden lg:block mb-8 text-base text-gray-300 dark:text-dark-6">
      ...
      <section className="overflow-hidden pt-10 pb-12 lg:pt-[10px]  lg:pb-[90px] lg:px-20  dark:bg-dark">
        <div className="container mx-auto">
          <div className="flex  flex-wrap-reverse items-center justify-between -mx-4">
            <div className="w-full px-4 lg:w-[30%]">
              <img alt="poss" src={img11} className="m-auto" />
            </div>
            <div className="w-full px-4 lg:w-[60%]  ">
              <div className="mt-10 lg:mt-0">
                <span className="block mb-0 text-lg font-semibold text-gray-200 text-primary">
