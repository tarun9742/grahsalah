...
export default function Hero1() {
  ...
  return (
    <div>
      <div
        className="relative bg-no-repeat bg-cover bg-opacity-50"
        style={{ backgroundImage: `url(${bggif1})` }}
      >
        <div className="absolute bg-black inset-0  opacity-60"></div>

        <section className="relative z-[9999] w-full h-auto flex flex-col-reverse lg:flex-row-reverse  lg:px-16">
          ...
          <div className="w-full h-auto lg:w-[50%]  flex flex-col mt-5 md:mt-10 lg:mt-20 ">
            ...
            <p className="text-white text-sm lg:text-lg mt-5 mx-2 px-5 lg:px-0 text-center lg:text-left">
            ...
            <div className="w-full flex justify-center lg:justify-start">
              <Link
                to={"/contact"}
                className="h-12 w-52 bg-[#432010] flex items-center justify-center rounded-full mt-5 p-1.5 mx-5 hover:opacity-80 transition "
              >
            ...
            <ul className="flex items-center text-white justify-center lg:justify-start gap-5 lg:gap-12 h-28 mt-5 z-10">
