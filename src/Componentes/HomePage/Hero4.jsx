  ...
  return (
    <div className="px-6 lg:px-16">
        ...
        <Slider {...settings}>
          {raaasi.map((item, index) => (
            <div className="px-2 pt-[70px] ">
              <div
                className="relative w-full h-60   shadow-md	hover:scale-110 cursor-pointer  rounded-xl bg-cover"
      ...
      >
        ...
        <Link
          to={"/horoscope"}
          className="relative z-[9999] mt-6 inline-block px-5 font-semibold py-2 mx-auto text-white bg-blue-600 rounded-full hover:bg-blue-700 md:mx-0"
        >
          VIEW
        </Link>
      </div>
